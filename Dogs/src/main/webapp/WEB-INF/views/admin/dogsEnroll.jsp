                    ...
                    <div class="admin_content_main">
                    	<form action="/admin/dogsEnroll" method="post" id="enrollForm" enctype="multipart/form-data">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
									<input type="file" multiple id ="fileMain" name='fileMain' style="height: 30px;">
									<div id="uploadResult">
									<!--<div id="result_card">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
									<input type="file" multiple id ="fileSub1" name='fileSub1' style="height: 30px;">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
									<input type="file" multiple id ="fileSub2" name='fileSub2' style="height: 30px;">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
									<input type="file" multiple id ="fileSub3" name='fileSub3' style="height: 30px;">
