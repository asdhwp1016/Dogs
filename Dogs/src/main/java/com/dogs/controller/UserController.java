...
import com.dogs.service.UserService;
...
public class UserController {
	...
	public String joinPOST(UserVO user) throws Exception{
		...
		user.setPassword(encodePw);	//인코딩된 비밀번호 user객체에 다시 저장
	...
	public String mailCheckGET(String email) throws Exception {
		...
		/*111111~999999 범위의 숫자를 얻기 위함*/
		int checkNum = random.nextInt(888888) + 111111;
		logger.info("인증번호 " + checkNum);
		
		/*이메일 보내기*/
		String setFrom = "asdhwp1016@naver.com";
		String toMail = email;
	...
	public String loginPOST(HttpServletRequest request, UserVO user, RedirectAttributes attr) throws Exception {
